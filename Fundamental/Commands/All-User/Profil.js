...
${client.emojis.cache.find(x => x.name === "ravgar_bit")} **Kullanıcı Bilgisi**
...
${client.emojis.cache.find(x => x.name === "ravgar_bit")} **Sunucu Bilgisi**
...
${client.emojis.cache.find(x => x.name === "ravgar_info")} Rolleri (${rolleri.length}): ${rolleri.join(", ")}
