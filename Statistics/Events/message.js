...
module.exports = async message => {
  ...
  if (client.commands.has(command)) {
    ...
    let kanal = !client.ayarlar.commandChannel.includes(message.channel.id) && !message.member.permissions.has("ADMINISTRATOR") && !message.member.permissions.has("MANAGE_CHANNELS");
      if (cmd) {
